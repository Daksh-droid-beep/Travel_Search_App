...
import { Compass, User, Mail, Lock, ArrowRight, AlertCircle, Loader, CheckCircle2 } from 'lucide-react';
...
export default function Signup({ setPage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Only show success screen if signup actually succeeded (no throw)
      if (result) {
        setIsSubmitted(true);
      }
    } catch (err) {
      // Error is set in AuthContext state and displayed below
      setIsSubmitted(false);
    } finally {
      setLoading(false);
    }
        ...
        {isSubmitted ? (
          ...
          <>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 mt-2 font-medium">Join WanderLust to plan your dream trips</p>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-2.5 bg-slate-900/60 border border-white/10 rounded-xl focus:border-teal-500/50 focus:ring-1 focus:ring-teal-500/30 text-white placeholder-gray-500 transition-all outline-none"
                    required
                  />
                </div>
              </div>
